// src/app/(public)/catalog/CatalogClient.tsx
"use client";
...
// DB row shape (matches products table)
    ...
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-200 group flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <Link
          ...
          className="font-semibold text-lg leading-snug hover:text-primary transition-colors mb-0.5"
        >
          {product.name}
        </Link>
        <p className="text-gray-400 text-base mb-2">{product.name_th}</p>
                ...
                <div className="space-y-1">
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-xl text-lg transition-colors ${
                        category === cat
              ...
              {filtered.length === 0 ? (
                <div className="text-center py-24 text-gray-400">
                  <div className="flex justify-center mb-4">
                    <IconSearch className="w-14 h-14 text-gray-300" />
                  </div>
